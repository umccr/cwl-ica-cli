...
# Local imports
from .ica_task_run import ICATaskRun
...
class ICAWorkflowRun:
    ...
    def get_workflow(self, ica_workflow_id: str, project_token: str) -> Workflow:
        """
        Get the workflow
        ...
        except LibWesApiException as e:
    ...
    def get_workflow_run_history(self, project_token):
        ...
        with LibWesApiClient(configuration) as api_client:
            # Create an instance of the API class
            api_instance = WorkflowRunsApi(api_client)
