...
from libica.openapi.libtes import (
    Configuration as LibTesConfiguration,
    ApiClient as LibTesApiClient, TaskRunsApi,
    ApiException as ApiTesException
)
from libica.openapi.libgds import (
    Configuration as LibGdsConfiguration,
    ApiClient as GDSApiClient,
    FilesApi,
    ApiException as APIGdsException,
)
...
class ICATaskRun:
    ...
    def get_tes_configuration(access_token):
        ...
        :return:
        """
        configuration = LibTesConfiguration(
            host=get_base_url(),
            api_key={
    ...
    def get_gds_configuration(access_token):
        ...
        :return:
        """
        configuration = LibGdsConfiguration(
            host=get_base_url(),
            api_key={
                "Authorization": access_token
            },
    ...
    def get_task_object(self, project_token):
        ...
        with LibTesApiClient(configuration) as api_client:
    ...
    def get_pod_metrics_file_url(self, pod_metrics_file, project_token):
        ...
        with GDSApiClient(configuration) as api_client:
            # Create an instance of the API class
