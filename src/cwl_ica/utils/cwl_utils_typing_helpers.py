...
WorkflowOutputParameterType = Union[
    WorkflowOutputParameter_v1_1,
    WorkflowOutputParameter_v1_2
]

WorkflowParameterType = Union[
    WorkflowInputParameterType,
    WorkflowOutputParameterType
]
