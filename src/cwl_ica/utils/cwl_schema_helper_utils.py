...
from .cwl_utils_typing_helpers import SchemaDefRequirementType

# Locals
from .logging import get_logger
from .cwl_helper_utils import get_path_from_cwl_id
from .repo import (
...
def get_schemas(cwl_item) -> List[Path]:
    ...
    for requirement in cwl_obj.requirements:
        if isinstance(requirement, SchemaDefRequirementType):
